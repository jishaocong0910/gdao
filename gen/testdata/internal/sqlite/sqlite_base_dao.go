// Code generated by https://github.com/jishaocong0910/gdao. DO NOT EDIT.
...
func (d baseDao[T]) Insert(req InsertReq[T]) (int64, error) {
	return d.Exec(gdao.ExecReq[T]{Ctx: req.Ctx, LastInsertIdAs: gdao.LAST_INSERT_ID_AS_LAST_ID, Entities: []*T{req.Entity},
