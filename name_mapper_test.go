...
func TestSubPrefix(t *testing.T) {
	r := require.New(t)
	mapper := orm.NewNameMapper().SubPrefix("Tb")
...
func TestSubSuffix(t *testing.T) {
	r := require.New(t)
	mapper := orm.NewNameMapper().SubSuffix("Po")
	r.Equal("", mapper.Convert(""))
...
func TestAddPrefix(t *testing.T) {
	r := require.New(t)
	mapper := orm.NewNameMapper().AddPrefix("Tb")
	r.Equal("", mapper.Convert(""))
...
func TestAddSuffix(t *testing.T) {
	r := require.New(t)
	mapper := orm.NewNameMapper().AddSuffix("Po")
	r.Equal("", mapper.Convert(""))
...
func TestLowerCamelCase(t *testing.T) {
	r := require.New(t)
	mapper := orm.NewNameMapper().LowerCamelCase()
	r.Equal("", mapper.Convert(""))
...
func TestLowerSnakeCase(t *testing.T) {
	r := require.New(t)
	mapper := orm.NewNameMapper().LowerSnakeCase()
	r.Equal("", mapper.Convert(""))
...
func TestLowerFirstLiteral(t *testing.T) {
	r := require.New(t)
	mapper := orm.NewNameMapper().LowerFirstLiteral()
	r.Equal("", mapper.Convert(""))
	r.Equal("tbProductPo", mapper.Convert("TbProductPo"))
}
...
func TestUpperCamelCase(t *testing.T) {
	r := require.New(t)
	mapper := orm.NewNameMapper().UpperCamelCase()
	r.Equal("", mapper.Convert(""))
	r.Equal("TbProductPo", mapper.Convert("tb_product_Po"))
	r.Equal("TbProductPo", mapper.Convert("Tb Product Po"))
	r.Equal("TbProductPo", mapper.Convert("Tb-Product-Po"))
...
func TestUpperSnakeCase(t *testing.T) {
	r := require.New(t)
	mapper := orm.NewNameMapper().UpperSnakeCase()
	r.Equal("", mapper.Convert(""))
	r.Equal("TB_PRODUCT_PO", mapper.Convert("TbProductPo"))
	r.Equal("TB_PRODUCT_PO", mapper.Convert("Tb Product Po"))
	r.Equal("TB_PRODUCT_PO", mapper.Convert("Tb-Product-Po"))
...
func TestUpperFirstLiteral(t *testing.T) {
	r := require.New(t)
	mapper := orm.NewNameMapper().UpperFirstLiteral()
	r.Equal("", mapper.Convert(""))
	r.Equal("TbProductPo", mapper.Convert("tbProductPo"))
}
