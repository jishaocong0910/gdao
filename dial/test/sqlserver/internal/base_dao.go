// Code generated by https://github.com/jishaocong0910/cozy-orm. FOR SQL Server. DO NOT EDIT.
...
func (l *list[T]) Do() ([]*T, error) {
	_, list, err := l.dao.Query().Ctx(l.ctx).Must(l.must).SqlLogLevel(l.sqlLogLevel).Desc(l.desc).BuildSql(func(b *orm.SqlBuilder[T]) {
		...
		b.WriteColumns(l.sel...).Write(" FROM ").WriteTable()
...
func (ib *insertBatch[T]) Do() error {
	_, _, err := ib.dao.Query().Ctx(ib.ctx).Must(ib.must).SqlLogLevel(ib.sqlLogLevel).Desc(ib.desc).RowAs(orm.RowAs_.LAST_ID).
