...
func TestMySql(t *testing.T) {
	...
	dial.GetGenerator(dial.GenCfg{
		DbType:    dial.DbType_.MYSQL,
		Dsn:       dsn,
		GoModPath: "../../..",
		PathCfg: dial.PathCfg{
			OutPath: "dial/test/mysql/testdata",
		},
		TableCfg: dial.TableCfg{
			Tables: dial.Tables{"test_table"},
			Ignores: dial.Ignores{
				"test_table": dial.Columns{
					"other",
				},
			},
		},
	...
	dial.GetGenerator(dial.GenCfg{
		...
		TableCfg: dial.TableCfg{
			Tables: dial.Tables{"test_table_logical_del_mode1"},
		},
		LogicalDelCfg: dial.LogicalDelCfg{
			Column:     "valid",
			QueryValue: "1",
		},
	}).Gen()
	...
	dial.GetGenerator(dial.GenCfg{
		...
		TableCfg: dial.TableCfg{
			Tables: dial.Tables{"test_table_logical_del_mode2"},
		},
		LogicalDelCfg: dial.LogicalDelCfg{
			Column:     "deleted",
			IdColumn:   "id",
