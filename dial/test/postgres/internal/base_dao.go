// Code generated by https://github.com/jishaocong0910/cozy-orm. FOR PostgreSQL. DO NOT EDIT.
...
func (ib *insertBatch[T]) Do() error {
	_, _, err := ib.dao.Query().Ctx(ib.ctx).Must(ib.must).SqlLogLevel(ib.sqlLogLevel).Desc(ib.desc).RowAs(orm.RowAs_.RETURNING).
		Entities(ib.entities...).BuildSql(func(b *orm.SqlBuilder[T]) {
		var columns []string
		if ib.all {
		...
		b.Repeat(len(b.AutoColumns()), b.SepFix(" RETURNING ", ",", "", true), nil, func(_, i int) {
