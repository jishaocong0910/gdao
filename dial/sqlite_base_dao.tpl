// Code generated by https://github.com/jishaocong0910/cozy-orm. FOR SQLite. DO NOT EDIT.
...
func (ib *insertBatch[T]) Do() (int64, error) {
	return ib.dao.Exec().Ctx(ib.ctx).Must(ib.must).SqlLogLevel(ib.sqlLogLevel).Desc(ib.desc).Entities(ib.entities...).
		LastInsertIdAs(orm.LastInsertIdAs_.LAST_ID).BuildSql(func(b *orm.SqlBuilder[T]) {
		var columns []string
		if ib.all {
