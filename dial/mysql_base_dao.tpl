// Code generated by https://github.com/jishaocong0910/cozy-orm. For MySQL. DO NOT EDIT.
...
// INSERT IGNORE ... clause
func (i *insert[T]) InsertIgnore(insertIgnore bool) *insert[T] {
	i.insertIgnore = insertIgnore
	return i
}

// INSERT ... ON DUPLICATE KEY UPDATE clause, create by function OnDuplicateKey.
...
func (i *insert[T]) Do() (int64, error) {
	return i.dao.InsertBatch().Ctx(i.ctx).Must(i.must).SqlLogLevel(i.sqlLogLevel).Desc(i.desc).Entities(i.entity).
		Nullable(i.nullable...).All(i.all).Ignore(i.ignore...).InsertIgnore(i.insertIgnore).OnDuplicateKey(i.onDuplKey).Do()
}
...
func (ib *insertBatch[T]) Do() (int64, error) {
	return ib.dao.Exec().Ctx(ib.ctx).Must(ib.must).SqlLogLevel(ib.sqlLogLevel).Desc(ib.desc).Entities(ib.entities...).
		LastInsertIdAs(orm.LastInsertIdAs_.FIRST_ID).BuildSql(func(b *orm.SqlBuilder[T]) {
		var columns []string
		if ib.all {
			columns = b.Columns(mergeColumns(ib.dao.autoIncrementColumns, ib.ignore))
		} else if len(ib.entities) > 0 {
			columns = b.AssignedColumns(ib.entities[0], ib.nullable, ib.dao.autoIncrementColumns)
		}

		b.Write("INSERT").WriteIf(" IGNORE", ib.insertIgnore).Write(" INTO ").WriteTable()
		...
		if ib.onDuplKey != nil {
			ib.onDuplKey.write(ib.dao.fieldNameToColumn, b.PlainSqlBuilder)
		}
	}).Do()
}
	...
	return u.dao.Exec().Ctx(u.ctx).Must(u.must).SqlLogLevel(u.sqlLogLevel).Desc(u.desc).Entities(u.entities...).BuildSql(func(b *orm.SqlBuilder[T]) {
		...
		b.EachColumn(b.Entity(), b.Sep(", "), func(_ int, column string, value any) {
			...
			b.EachEntity(nil, func(_ int, entity *T) {
				...
				if value != nil {
					b.Write("?", b.ColumnValue(entity, column))
				} else {
					b.Write("NULL")
				}
			})
...
func (b *baseDaoBuilder[T]) Build() *baseDao[T] {
	...
	b.baseDao.autoIncrementColumns = *(*[]string)(unsafe.Pointer(reflect.ValueOf(dao).Elem().FieldByName("autoIncrementColumns").UnsafeAddr()))
	return b.baseDao
}
...
func (o *OnDuplKey) Update(column string, value any) *OnDuplKey {
	o.items = append(o.items, onDuplKeyItem{column: column, value: value})
	return o
}

func (o *OnDuplKey) UpdatePlain(column, value string) *OnDuplKey {
	o.items = append(o.items, onDuplKeyItem{column: column, value: value, plain: true})
	return o
}

func (o *OnDuplKey) write(nameMap map[string]string, b *orm.PlainSqlBuilder) {
